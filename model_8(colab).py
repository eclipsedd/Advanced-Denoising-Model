"""
Improvement from model 6 with batch size=16, dynamic epoch calculation.
Thus .repeat() and .shuffle() method are not needed. 
"""
...
if __name__ == "__main__":
    ...
    keras.saving.save_model(
        mymodel,
        "/content/drive/MyDrive/Img_Enhancement/low_light_enhancement_model8(colab).keras",
    )
