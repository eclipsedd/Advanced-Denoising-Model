# similar to model 4 but with more epochs and small batch size.
...
if __name__ == "__main__":
    ...
    # Save the model
    mymodel.save(
        "/content/drive/MyDrive/vlg_project/low_light_enhancement_model5(colab).h5"
    )
    mymodel.save(
        "/content/drive/MyDrive/vlg_project/low_light_enhancement_model5(colab).keras"
    )
