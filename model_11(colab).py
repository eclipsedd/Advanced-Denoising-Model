# model 10
# an attempt to add layers upto 128 ->non practical even for colab GPU
...
def build_image_enhancement_model(input_shape):
    ...
    # Skip Connection
    output = layers.Add()([inputs, conv8])
...
if __name__ == "__main__":
    ...
    BATCH_SIZE = 16
    TRAINING_SET = 485
    epochs = int((TRAINING_SET * 0.9) // BATCH_SIZE)
    ...
    keras.saving.save_model(
        mymodel,
        "/content/drive/MyDrive/Img_Enhancement/low_light_enhancement_model10(colab).keras",
    )
