"""
An improved version of model 4 (30 epochs). 
Built on newer version of Tensorflow i.e. 2.16.1

added .repeat() for improved functionality and consistency.
"""
...
if __name__ == "__main__":
    ...
    keras.saving.save_model(
        mymodel,
        "/content/drive/MyDrive/Img_Enhancement/low_light_enhancement_model6(colab).keras",
    )
